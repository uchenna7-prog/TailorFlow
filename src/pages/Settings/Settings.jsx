...
export default function Settings({ onMenuClick }) {
  ...
  const [editModal, setEditModal] = useState(null) // { key, title, placeholder, multiline }
  ...
  return (
    <div className={styles.page}>
      ...
      <div className={styles.scrollArea}>
        ...
        <div className={styles.card}>
          <SettingRow icon="square_foot" label="Default Unit" sub="Used when adding new measurements">
            <SegmentControl
              options={UNIT_OPTIONS}
              value={settings.measureUnit}
              onChange={v => { updateSetting('measureUnit', v); showToast('Unit updated ✓') }}
            />
          </SettingRow>
        </div>
        ...
        <div className={styles.card}>
          <SettingRow icon="sewing" label="TailorBook" sub="Your tailor shop, organised" />

          <div className={styles.divider} />

          <SettingRow icon="code" label="Version" >
            <span className={styles.rowValue}>1.0.0</span>
          </SettingRow>

          <div className={styles.divider} />

          <SettingRow icon="devices" label="Platform" >
            <span className={styles.rowValue}>PWA · React + Vite</span>
          </SettingRow>

          <div className={styles.divider} />

          <SettingRow icon="lock" label="Privacy" sub="All data stored locally on your device" />
        </div>
